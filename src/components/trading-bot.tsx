          ...
          <div className="w-full">
            <div className="text-center">
              <motion.div
                ...
                className="bg-gradient-to-r from-blue-600 to-teal-600 p-8 rounded-2xl flex flex-col items-center"
              >
                <h2 className="text-3xl font-bold mb-4">Ready to Start Trading Smarter?</h2>
                <p className="text-xl mb-6 text-gray-200">Make millions on BNB Chain using Coin Master</p>
